...
instance instGCDMonoid : GCDMonoid (Associates α) where
  gcd := Quotient.map₂' gcd fun _ _ (ha : Associated _ _) b₁ b₂ (hb : Associated _ _) => ha.gcd hb
  lcm := Quotient.map₂' lcm fun _ _ (ha : Associated _ _) b₁ b₂ (hb : Associated _ _) => ha.lcm hb
