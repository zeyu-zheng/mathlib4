...
@[deprecated (since := "2024-10-14")] alias mapIdxGo_append := mapIdx_go_append

@[deprecated (since := "2024-10-14")] alias mapIdxGo_length := mapIdx_go_length

@[deprecated (since := "2024-10-14")] alias mapIdx_append_one := mapIdx_concat
